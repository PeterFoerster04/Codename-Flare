...
AVehicleGameOffroadCar::AVehicleGameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleGameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleGameOffroadWheelRear::StaticClass();
